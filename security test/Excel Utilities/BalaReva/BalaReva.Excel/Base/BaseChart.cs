        ...
        protected void DrawChart(XlChartType ChartType)
        {
            ...
            try
            {
                ...
                if (base.SheetIndex > 0 && base.xlWorkSheet != null)
                {
                    ...
                    // Legend show / hide
                    chart.HasLegend = this.Options.ShowLegend;
                    ...
                    XlDataLabelsType XlLegendKey = (XlDataLabelsType)this.Options.LegendKey;

                    // assign the data lable properties
                    chart.ApplyDataLabels(XlDataLabelsType, XlLegendKey, this.Options.AutoText, this.Options.HasLeaderLines,
